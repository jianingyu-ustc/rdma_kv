...
│     │                                    │                                │
│     │              小数据 (< 4KB)        │                                │
│     │  1a. rdma_send ───────────────────►│  [header][key][value]         │
│     │                                    │                                │
│     │                                    │  2a. hash_table_put()          │
│     │                                    │                                │
│     │  3a. rdma_recv ◄──────────────────│  [header] (status, version)    │
│     │                                    │                                │
│     │              大数据 (>= 4KB)       │                                │
│     │  1b. rdma_send ───────────────────►│  [header][key] (请求分配空间) │
│     │                                    │                                │
│     │  2b. rdma_recv ◄──────────────────│  [remote_addr, rkey]           │
│     │                                    │                                │
│     │  3b. rdma_write ──────────────────►│  直接写入远程内存              │
│     │      [value] ─────────────────────►│  (服务端 CPU 不参与)          │
│     │                                    │                                │
│     │  4b. rdma_send ───────────────────►│  [完成通知]                    │
│     │                                    │                                │
